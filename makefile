...
define BUILD_FULL_SCRATCHPAD_WITH_MODEMFW
	...
	$(D)$(SCRAT_GEN)    --configfile=$(BOOTLOADER_CONFIG_INI) \
						$(1) \
						$(modemfw_area_id):$(2) \
						$(patsubst %.hex,%.conf,$(3)):$(stack_area_id):$(3) \
...
define BUILD_FULL_SCRATCHPAD
	...
	$(D)$(SCRAT_GEN)    --configfile=$(BOOTLOADER_CONFIG_INI) \
						$(1) \
						$(patsubst %.hex,%.conf,$(2)):$(stack_area_id):$(2) \
...
define BUILD_STACK_SCRATCHPAD_WITH_MODEMFW
	@echo "  Creating Stack Scratchpad with modem: $(2) + $(3) -> $(1)"
	$(D)$(SCRAT_GEN)    --configfile=$(BOOTLOADER_CONFIG_INI) \
						$(1) \
						$(modemfw_area_id):$(2) \
						$(patsubst %.hex,%.conf,$(3)):$(stack_area_id):$(3)
...
$(STACK_SCRATCHPAD_WITH_MODEMFW_BIN): initial_setup $(STACK_HEX) $(APP_HEX) $(BOOTLOADER_CONFIG_INI)
