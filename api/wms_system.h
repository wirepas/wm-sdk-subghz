 ...
 * convenient to do so.
 *
 * Library services are accessed via [lib_system](@ref app_lib_system_t)
 * handle.
 */
...
#define APP_LIB_SYSTEM_VERSION          0x202
 ...
 *
 * This number is returned by [lib_system->getRadioInfo()](@ref app_lib_system_get_radio_info_f) function and can be used by the application
...
typedef enum
{
    ...
    /** Obsolete reserved value */
    APP_LIB_SYSTEM_HARDWARE_RESERVED_6          = 13,
    /** Obsolete reserved value */
    APP_LIB_SYSTEM_HARDWARE_RESERVED_7          = 14,
    /** Obsolete reserved value */
    APP_LIB_SYSTEM_HARDWARE_RESERVED_8          = 15,
    ...
    /** Nordic Semiconductor nRF9161, nRF9131 or nRF9151 (a.k.a nRF9120) */
    APP_LIB_SYSTEM_HARDWARE_MAGIC_NRF9120       = 18,
    /** Nordic Semiconductor nRF54L */
    APP_LIB_SYSTEM_HARDWARE_MAGIC_NRF54L        = 19,
    /** Texas Instruments CC1354P10 */
    APP_LIB_SYSTEM_HARDWARE_MAGIC_CC1354P10     = 20,
    /** Silicon Labs EFR32xG21 with debug image memory map */
    APP_LIB_SYSTEM_HARDWARE_MAGIC_EFR32XG21_DBG = 21,
    /** Silicon Labs EFR32xG22 with debug image memory map */
    APP_LIB_SYSTEM_HARDWARE_MAGIC_EFR32XG22_DBG = 22,
    /** Silicon Labs EFR32xG24 with debug image memory map */
    APP_LIB_SYSTEM_HARDWARE_MAGIC_EFR32XG24_DBG = 23,
 ...
 * [lib_system->getRadioInfo()](@ref app_lib_system_get_radio_info_f).
 */
typedef enum
{
    ...
    /** SubG India 865 Non Whitening starting 5.8 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_SUB_INDIA865NW           = 6,
    /** Obsolete reserved value */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_RESERVED_7               = 7,
    /** SubG India 865 Whitening starting 5.5 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_SUB_INDIA865W            = 8,
    /** Obsolete reserved value */
    ...
    /** DECT NR+ Band 1 Smart metering  */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_TS_103_874_2_BAND_1 = 12,
    /** Reserved for DECT NR+ Band 2 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_2_RESERVED     = 13,
    /** Reserved for DECT NR+ Band 3 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_3_RESERVED     = 14,
    /** DECT NR+ Band 4 Smart metering */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_TS_103_874_2_BAND_4 = 15,
    /** Reserved for DECT NR+ Band 5 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_5_RESERVED     = 16,
    /** Reserved for DECT NR+ Band 6 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_6_RESERVED     = 17,
    /** Reserved for DECT NR+ Band 7 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_7_RESERVED     = 18,
    /** Reserved for DECT NR+ Band 8 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_8_RESERVED     = 19,
    /** DECT NR+ Band 9 Smart metering  */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_TS_103_874_2_BAND_9 = 20,
    /** Reserved for DECT NR+ Band 10 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_10_RESERVED    = 21,
    /** Reserved for DECT NR+ Band 11 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_11_RESERVED    = 22,
    /** Reserved for DECT NR+ Band 12 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_12_RESERVED    = 23,
    /** Reserved for DECT NR+ Band 13 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_13_RESERVED    = 24,
    /** Reserved for DECT NR+ Band 14 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_14_RESERVED    = 25,
    /** Reserved for DECT NR+ Band 15 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_15_RESERVED    = 26,
    /** Reserved for DECT NR+ Band 16 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_16_RESERVED    = 27,
    /** Reserved for DECT NR+ Band 17 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_17_RESERVED    = 28,
    /** Reserved for DECT NR+ Band 18 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_18_RESERVED    = 29,
    /** Reserved for DECT NR+ Band 19 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_19_RESERVED    = 30,
    /** Reserved for DECT NR+ Band 20 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_20_RESERVED    = 31,
    /** Reserved for DECT NR+ Band 21 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_21_RESERVED    = 32,
    /** Reserved for DECT NR+ Band 22 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_22_RESERVED    = 33,
    /** Reserved for possible future DECT NR+ standard Band 23 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_23_RESERVED    = 34,
    /** Reserved for possible future DECT NR+ standard Band 24 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_24_RESERVED    = 35,
    /** Reserved for possible future DECT NR+ standard Band 25 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_25_RESERVED    = 36,
    /** Reserved for possible future DECT NR+ standard Band 26 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_26_RESERVED    = 37,
    /** Reserved for possible future DECT NR+ standard Band 27 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_27_RESERVED    = 38,
    /** Reserved for possible future DECT NR+ standard Band 28 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_28_RESERVED    = 39,
    /** Reserved for possible future DECT NR+ standard Band 29 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_29_RESERVED    = 40,
    /** Reserved for possible future DECT NR+ standard Band 30 */
    APP_LIB_SYSTEM_PROTOCOL_PROFILE_DECT_BAND_30_RESERVED    = 41,
} app_lib_system_protocol_profile_e;

/**
 * @brief   Radio information structure
 *
 * Information returned by [lib_system->getRadioInfo()](@ref app_lib_system_get_radio_info_f)
 */
typedef struct
{
 ...
 * the stack is started by calling [lib_state->startStack()](@ref app_lib_state_start_stack_f) function in the State library ( @ref wms_state.h). If
 * the stack is running initially, the startup callback is not called at all.
 * Any code, including interrupts can use [lib_system->setStartupCb()](@ref app_lib_system_set_startup_cb_f) function to set or change the startup callback.
 *
 ...
 * API) is causing the stack to stop. The [lib_system->setShutdownCb](@ref app_lib_system_set_shutdown_cb_f)() function can be used to set or change the
 * shutdown callback.
 *
 ...
 *
 * Any code, including interrupts can use [lib_system->setPeriodicCb](@ref app_lib_system_set_periodic_cb_f)() function to set or change the periodic
 ...
 * function. This function and [lib_system->enterCriticalSection()](@ref app_lib_system_enter_critical_section_f) can be nested. Interrupts are enabled
 ...
 */
typedef app_res_e
    (*app_lib_system_enable_app_irq_f)(uint16_t irq_n);
 ...
 */
typedef app_res_e
    (*app_lib_system_disable_app_irq_f)(uint16_t irq_n);
 ...
 */
typedef app_res_e
    (*app_lib_system_enable_fast_app_irq_f)(uint16_t irq_n, uint8_t priority);
 ...
 * the [lib_system->setPeriodicCb](@ref app_lib_system_set_periodic_cb_f)()
 ...
 */
typedef app_res_e
    (*app_lib_system_clear_pending_fast_app_irq_f)(uint16_t irq_n);
