 ...
 */
typedef app_lib_mem_area_res_e (*app_lib_mem_area_startRead_f)(
    app_lib_mem_area_id_t id, void * to, uint32_t from, size_t amount);
 ...
 *         See \ref app_lib_mem_area_res_e for other result codes.
 */
typedef app_lib_mem_area_res_e (*app_lib_mem_area_startWrite_f)(
    app_lib_mem_area_id_t id, uint32_t to, const void * from, size_t amount);
 ...
 *         See \ref app_lib_mem_area_res_e for other result codes.
 */
typedef app_lib_mem_area_res_e (*app_lib_mem_area_startErase_f)(
 ...
 *         See \ref app_lib_mem_area_res_e for other result codes.
 */
typedef app_lib_mem_area_res_e (*app_lib_mem_area_getAreaInfo_f)(
    app_lib_mem_area_id_t id, app_lib_mem_area_info_t * info);
 ...
 * \return none
 */
typedef void (*app_lib_mem_area_getAreaList_f)(app_lib_mem_area_id_t * list,
                                               uint8_t * num_areas);
