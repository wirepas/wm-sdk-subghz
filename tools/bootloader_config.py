...
""".format(
                config.get_bootloader_area().id,
                config.get_bootloader_area().address,
                config.get_bootloader_area().length,
                config.get_wirepas_stack_area().id,
                config.get_wirepas_stack_area().address,
                config.get_wirepas_stack_area().length,
            )
        )
...
def main():
    ...
    try:
        ...
        if args.out_file or args.out_makefile:
