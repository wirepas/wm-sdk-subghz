...
extern const app_lib_secure_storage_t * lib_secure_storage  __attribute((weak));
 ...
 * continue using those pointers. It is no more mandatory to call it from the App_init().
 * SDK has been updated to call it by default internally. Calling it has no effects. 
 *
