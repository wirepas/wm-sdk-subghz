...
typedef enum
{
    ...
    /* MSAP-CONFIG_DATA_ITEM_SET */
    WAPS_FUNC_MSAP_CONFIG_DATA_ITEM_SET_REQ = 0x29,
    WAPS_FUNC_MSAP_CONFIG_DATA_ITEM_SET_CNF = 0xA9,
    /* MSAP-CONFIG_DATA_ITEM_GET */
    WAPS_FUNC_MSAP_CONFIG_DATA_ITEM_GET_REQ = 0x30,
    WAPS_FUNC_MSAP_CONFIG_DATA_ITEM_GET_CNF = 0xB0,
    /* MSAP-CONFIG_DATA_ITEM_IND */
    WAPS_FUNC_MSAP_CONFIG_DATA_ITEM_IND = 0x31,
    WAPS_FUNC_MSAP_CONFIG_DATA_ITEM_RSP = 0xB1,
    /* MSAP-CONFIG_DATA_LIST_ITEMS */
    WAPS_FUNC_MSAP_CONFIG_DATA_LIST_ITEMS_REQ = 0x32,
    WAPS_FUNC_MSAP_CONFIG_DATA_LIST_ITEMS_CNF = 0xB2,
