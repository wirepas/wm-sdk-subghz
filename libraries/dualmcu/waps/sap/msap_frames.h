...
typedef enum
{
    ...
    MSAP_CONFIG_DATA_ITEM_SET_SUCCESS = 0,
    /** Error: cannot write config data: node is not a sink */
    MSAP_CONFIG_DATA_ITEM_SET_INVALID_ROLE = 1,
    /** Error: cannot read config data: no config data item set or received for
       that endpoint */
    MSAP_CONFIG_DATA_ITEM_SET_INVALID_ENDPOINT = 2,
    /** Error: out of memory */
    MSAP_CONFIG_DATA_ITEM_SET_OUT_OF_MEMORY = 3,
    /** Error: invalid content */
    MSAP_CONFIG_DATA_ITEM_SET_INVALID_CONTENT = 4,
    /** Error: Feature not supported */
    MSAP_CONFIG_DATA_ITEM_SET_NOT_SUPPORTED = 5,
} msap_config_data_item_set_e;

/** MSAP-CONFIG_DATA_ITEM_SET confirmation frame */
typedef struct __attribute__((__packed__))
{
    /** Set result: \see msap_config_data_item_set_e */
    uint8_t result;
...
{
    /** Set request was successful */
    MSAP_CONFIG_DATA_ITEM_GET_SUCCESS = 0,
    /** Error: cannot read config data: no config data item set or received for
       that endpoint */
    MSAP_CONFIG_DATA_ITEM_GET_INVALID_ENDPOINT = 1,
    /** Error: Feature not supported with this WM stack version*/
    MSAP_CONFIG_DATA_ITEM_GET_NOT_SUPPORTED = 2,
...
typedef struct __attribute__((__packed__))
{
    /** Set result: \see msap_config_data_item_get_e */
    uint8_t result;
    /** Number of bytes of data */
    uint8_t npd_payload_len;
    /** Data */
...
{
    /** Set request was successful */
    MSAP_CONFIG_DATA_LIST_ITEMS_SUCCESS = 0,
    /** Error: Feature not supported */
    MSAP_CONFIG_DATA_LIST_ITEMS_NOT_SUPPORTED = 1,
} msap_config_data_list_items_e;

/** Maximum number of endpoints in the list at @ref msap_config_data_list_items_cnf_t.endpoints */
#define MSAP_CONFIG_DATA_LIST_ITEMS_MAX_NUM_ENDPOINTS 16

/** Header size of @ref msap_config_data_list_items_cnf_t */
