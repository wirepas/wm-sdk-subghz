...
It is hosted [here](https://wirepas.github.io/wm-sdk-subghz/).
...
### Gateway inactivity monitoring

Sink nodes with dualMCU library will have the Gateway inactivity monitoring enabled by default.
To disable the gateway inactivity monitoring feature provide the following `make` command build flag `gateway_monitoring=no`. Other than sink nodes with dual MCU library this flag has no effect.
